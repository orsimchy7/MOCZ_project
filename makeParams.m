...
a = -5; %min voltage amplitude [V]
b = 5;% to[ voltage amplitude [V]
...
L = 25; % additional taps that the channel conv adds
K = 5 ; %X(z) polynomial order. there are K+1 coefficents
lambda = 1;
Kidxs = 0:K-1;
